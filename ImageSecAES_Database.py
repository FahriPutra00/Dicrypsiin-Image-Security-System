...
def main_user():
    with st.sidebar:
        selected = option_menu("Menu",["Encoding Image","Decoding Image","Database","Log out","About"],key="main_user",
                            icons=['file-earmark-arrow-up','blockquote-left',"archive",'box-arrow-right', 'gear'], menu_icon="cast",
        ...
        if file is not None:
            ...
            with st.container():
                ...
                with col2:
                    ...
                    upload_to_database = st.checkbox("Upload to database", value=True, key="upload_to_database")
